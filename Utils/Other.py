...
def OSMakeFolder(a_path) :
    if not os.path.exists(a_path) :
        distutils.dir_util.mkpath(a_path)
...
if __name__ == "__main__" :
    ...
    OSDeleteFiles('d:\\maersk\\python\\reportdist\\out\\custperf\\*.*', FOLDERDELETE_OPTS_INCREADONLY())
    l_val = 0
    ...
    #l_val = IsYesOrNo('yes')
    #l_val = IsYesOrNo(0)
    #l_val = IsYesOrNo(False)
    #l_val = IsYesOrNo('true')
    #l_val = IsYesOrNo('true', 'x', 'y')
    #
    #l_val = 0
